...
--
-- Table structure for table `faq_comment`
--

DROP TABLE IF EXISTS `faq_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `faq_comment`
--

LOCK TABLES `faq_comment` WRITE;
/*!40000 ALTER TABLE `faq_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `faq_comment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `faq_configure`
--

DROP TABLE IF EXISTS `faq_configure`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `faq_configure` (
  ...
  `encodeName` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `faq_configure`
--

LOCK TABLES `faq_configure` WRITE;
/*!40000 ALTER TABLE `faq_configure` DISABLE KEYS */;
/*!40000 ALTER TABLE `faq_configure` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `faq_guestBook`
--

DROP TABLE IF EXISTS `faq_guestBook`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `faq_guestBook`
--

LOCK TABLES `faq_guestBook` WRITE;
/*!40000 ALTER TABLE `faq_guestBook` DISABLE KEYS */;
/*!40000 ALTER TABLE `faq_guestBook` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `faq_userlog`
--

DROP TABLE IF EXISTS `faq_userlog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `faq_userlog`
--

LOCK TABLES `faq_userlog` WRITE;
/*!40000 ALTER TABLE `faq_userlog` DISABLE KEYS */;
/*!40000 ALTER TABLE `faq_userlog` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `faq_weblog`
--

DROP TABLE IF EXISTS `faq_weblog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `faq_weblog`
--

LOCK TABLES `faq_weblog` WRITE;
/*!40000 ALTER TABLE `faq_weblog` DISABLE KEYS */;
/*!40000 ALTER TABLE `faq_weblog` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-30 13:58:44
